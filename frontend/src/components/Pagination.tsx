...
export const Pagination: React.FC<PaginationProps> = ({
    ...
    return (
        <div className="flex items-center justify-center mt-2 space-x-2 text-[#15372c]  text-[16px] font-medium select-none">
            {/* Prev */}
            <button
            ...
            {pages.map((p, idx) =>
                p === "..." ? (
                    ...
                    <button
                        ...
                        className={`px-3 py-1 rounded-md transition ${p === currentPage
                            ? "bg-[#EFF1F0] text-[#15372C]"
                            : "hover:bg-[#f3f7f4]"
                            }`}
                    >
                        {p}
